		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(dataSourceName, "target_ip_id", resourceName, "target_ip_id"),
					resource.TestCheckResourceAttrPair(dataSourceName, "a_record_effective", resourceName, "a_record_effective"),
					resource.TestCheckResourceAttrPair(dataSourceName, "ptr_record_effective", resourceName, "ptr_record_effective"),
					...
					resource.TestCheckResourceAttrPair("data.cherryservers_ip.test_ip_ip_by_address", "target_ip_id", resourceName, "target_ip_id"),
					resource.TestCheckResourceAttrPair("data.cherryservers_ip.test_ip_ip_by_address", "a_record_effective", resourceName, "a_record_effective"),
					resource.TestCheckResourceAttrPair("data.cherryservers_ip.test_ip_ip_by_address", "ptr_record_effective", resourceName, "ptr_record_effective"),
